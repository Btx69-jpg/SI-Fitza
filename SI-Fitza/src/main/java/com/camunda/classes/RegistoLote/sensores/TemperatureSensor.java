 ...
 * </p>
 * <p>
 * **Nota:** Assume-se que esta classe utiliza a anotação {@code @JsonTypeName("temperature")}
 * ou similar na sua implementação para suportar a deserialização polimórfica pelo Jackson,
 * seguindo a estrutura de classes {@link RoomSensor} (não visível aqui).
 * </p>
 */
public class TemperatureSensor extends RoomSensor {
     ...
     * @param location Localização na fábrica (ex: "Sala de Fermentação A").
